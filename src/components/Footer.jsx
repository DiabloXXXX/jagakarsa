        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-20 pt-12 border-t border-primary-light">
            ...
            <div className="flex gap-6">
              <SocialLink icon={<Facebook size={32} />} href="#" label="Facebook" />
              <SocialLink icon={<Youtube size={32} />} href="#" label="YouTube" />
              <SocialLink icon={<Instagram size={32} />} href="#" label="Instagram" />
              <SocialLink icon={<TrendingUp size={32} />} href="#" label="TikTok" />
            </div>
          </div>
        </div>
      </div>
