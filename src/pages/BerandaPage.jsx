...
export default function BerandaPage({ setCurrentPage, onOpenChatbot }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-96 md:h-[586px] bg-cover bg-center overflow-hidden mt-3.5">
        <img
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-5xl md:text-6xl lg:text-6xl font-extrabold text-white mb-8 leading-tight max-w-4xl">
          ...
          <button 
            ...
            className="bg-secondary hover:bg-orange-600 text-black font-semibold py-3 px-8 rounded-3xl flex items-center gap-3 transition-all transform hover:scale-105 text-2xl"
          >
            Lihat Beranda
            <ArrowRight size={24} />
          </button>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-2xl md:text-2xl text-black leading-relaxed space-y-6">
            <p>
      ...
      <section className="py-16 md:py-24 bg-primary-lighter">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-primary-dark mb-12">Batas Wilayah Kelurahan</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-black mb-12">Prestasi Kelurahan Jagakarsa</h2>
            ...
            {achievements.map((achievement, index) => (
              <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="p-6 space-y-4">
                  <p className="text-2xl font-semibold text-black">{achievement.type}</p>
                  <h3 className="text-2xl font-semibold text-black line-clamp-2">
                    {achievement.title}
                  </h3>
                  <p className="text-xl text-gray-600">{achievement.date}</p>
