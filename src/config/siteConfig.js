// Site Configuration - Kelurahan Jagakarsa
...
export const visitorStats = {
  ...
  monthlyVisitors: '2,150'
}

export const socialLinks = {
  facebook: 'https://facebook.com/kelurahanjagakarsa',
  instagram: 'https://instagram.com/kelurahanjagakarsa',
  youtube: 'https://youtube.com/@kelurahanjagakarsa',
  tiktok: 'https://tiktok.com/@kelurahanjagakarsa'
}

export const headerConfig = {
  title: 'Selamat Datang Di Website Kelurahan Jagakarsa',
  subtitle: 'Pusat Informasi dan Layanan Kelurahan Jagakarsa, Kecamatan Jagakarsa, Jakarta Selatan',
  ctaText: 'Lihat Beranda'
}

export const pjlpInfo = {
  ppsu: {
